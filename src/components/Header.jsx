    ...
    <header className={`${styles.header} ${isScrolled ? styles.scrolled : ''}`}>
      <div className={styles.container}>
        ...
        <a href="#home" className={styles.logo} onClick={closeMobileMenu}>
          <span className={styles.logoIcon}>MR</span>
          <span className={styles.logoText}>
            <span className={styles.logoName}>Manish</span>
      ...
      <div className={`${styles.mobileMenu} ${isMobileMenuOpen ? styles.open : ''}`}>
        ...
        <div className={styles.sidebar}>
          <div className={styles.sidebarHeader}>
            <a href="#home" className={styles.sidebarLogo} onClick={closeMobileMenu}>
              <span className={styles.logoIcon}>MR</span>
              <span className={styles.sidebarLogoText}>Manish Raghuwanshi</span>
            </a>
            <button 
          ...
          <div className={styles.sidebarFooter}>
            ...
            <p className={styles.sidebarContact}>manishraghuwanshiofficial@gmail.com</p>
          </div>
        </div>
      </div>
    </header>
